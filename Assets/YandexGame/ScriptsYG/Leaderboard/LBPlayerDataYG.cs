            ...
            if (topPlayerActivityComponents.Length > 0)
            {
                if (data.inTop)
                {
                    if (data.rank == 1.ToString())
                    {
                        ...
                        topPlayerActivityComponents[3].gameObject.SetActive(true);
                        topPlayerActivityComponents[4].gameObject.SetActive(false);
                        topPlayerActivityComponents[5].gameObject.SetActive(false);
                    }
                    else if (data.rank == 2.ToString())
                    {
                        ...
                        topPlayerActivityComponents[2].gameObject.SetActive(false);
                        topPlayerActivityComponents[3].gameObject.SetActive(false);
                        topPlayerActivityComponents[4].gameObject.SetActive(true);
                        topPlayerActivityComponents[5].gameObject.SetActive(false);
                    }
                    else if (data.rank == 3.ToString())
                    {
                        ...
                        topPlayerActivityComponents[3].gameObject.SetActive(false);
                        topPlayerActivityComponents[4].gameObject.SetActive(false);
                        topPlayerActivityComponents[5].gameObject.SetActive(true);
                    }
